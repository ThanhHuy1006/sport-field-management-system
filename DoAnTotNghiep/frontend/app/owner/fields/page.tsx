    ...
    <main data-cy="owner-fields-page" className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <Card data-cy="owner-fields-toolbar" className="p-4 mb-4">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            >
              <SelectTrigger data-cy="owner-field-status-filter" className="w-full md:w-[200px]">
        ...
        <div data-cy="owner-fields-result-count" className="text-sm text-muted-foreground mb-4">
        ...
        {!isLoading && filteredFields.length > 0 && (
          <div data-cy="owner-fields-list" className="space-y-4 mb-8">
            {paginatedFields.map((field) => (
              <Card key={field.id} data-cy="owner-field-card" className="overflow-hidden">
                  ...
                  <div className="flex-1 p-6 flex flex-col justify-between">
                    <div>
                      <div className="flex items-start justify-between mb-4 gap-4">
                        <div>
                          <h3 data-cy="owner-field-name" className="text-xl font-bold text-foreground mb-1">{field.name}</h3>
                        ...
                        <span data-cy="owner-field-status" className={`px-3 py-1 rounded-full text-sm font-medium ${getStatusClass(field.status)}`}>
                    ...
                    <div className="flex gap-2 pt-4 border-t border-border">
                      <Link href={`/owner/fields/${field.id}/edit`}>
                        <Button data-cy="owner-edit-field-button" variant="outline" size="sm">
      ...
      <Dialog open={hideDialog !== null} onOpenChange={() => setHideDialog(null)}>
        <DialogContent data-cy="owner-hide-field-dialog">
          ...
          <DialogFooter>
            <Button data-cy="owner-hide-cancel-button" variant="outline" onClick={() => setHideDialog(null)}>
              Hủy
            </Button>
            <Button data-cy="owner-hide-confirm-button" variant="destructive" onClick={() => hideDialog && handleHideField(hideDialog)}>
              Xác Nhận Ẩn
            </Button>
          </DialogFooter>
        </DialogContent>
