      ...
      <div className="w-full max-w-md">
        ...
        <Card className="p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-2">Nhập email để nhận hướng dẫn đặt lại mật khẩu</p>
          </div>
          ...
          {!submitted ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground mb-6">Chúng tôi đã gửi hướng dẫn đặt lại mật khẩu đến {email}</p>
