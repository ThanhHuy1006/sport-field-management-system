...
export default function AdminReviewsPage() {
  ...
  const handleDeleteReview = (reviewId: number) => {
    ...
    toast({
      ...
      description: "Đánh giá đã được xóa khỏi hệ thống vĩnh viễn.",
    })
  ...
  const handleApproveReview = (reviewId: number) => {
    setReviews(
      reviews.map((review) =>
        review.id === reviewId ? { ...review, status: "approved" as ReviewStatus, reports: 0 } : review,
      ),
    )
    toast({
      title: "Đã duyệt đánh giá",
      description: "Đánh giá đã được duyệt và hiển thị công khai.",
    })
  }
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            ...
                            <AlertDialogFooter>
                              ...
                              <AlertDialogAction onClick={() => handleDeleteReview(review.id)}>Xóa</AlertDialogAction>
                            </AlertDialogFooter>
                          </AlertDialogContent>
                        </AlertDialog>
                      </div>
