        ...
        <Card className="p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            {error && (
              <div
                data-cy="login-error"
                className="flex items-start gap-2 rounded-md border border-red-500/30 bg-red-500/10 px-3 py-2 text-sm text-red-600"
              >
            ...
            <Button data-cy="login-submit" type="submit" className="w-full" disabled={isSubmitting}>
