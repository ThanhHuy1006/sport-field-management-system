...
export default function FieldDetailsPage() {
  ...
  // ============ Chuyển ảnh ============
  const nextImage = () => setCurrentImageIndex((prev) => (prev + 1) % field.images.length)
  const prevImage = () => setCurrentImageIndex((prev) => (prev - 1 + field.images.length) % field.images.length)
