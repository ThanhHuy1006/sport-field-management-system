    ...
    <main className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-50 bg-background border-b border-border">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <h1 className="text-xl font-bold">Giá & Giờ Hoạt Động</h1>
          ...
          {Object.entries(pricing).map(([key, field]) => (
            <Card key={key} className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  <label className="block text-sm font-medium text-foreground mb-2">Giá Ngày Thường (T2-T6)</label>
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <span className="text-muted-foreground">VND/giờ</span>
                  </div>
                </div>

                <div>
                  <label className="block text-sm font-medium text-foreground mb-2">Giá Cuối Tuần (T7-CN)</label>
                  <div className="flex items-center gap-2">
                    <Input
                      type="number"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-foreground mb-2">Giờ Mở Cửa</label>
                  <Input
                    type="time"
                ...
                <div>
                  <label className="block text-sm font-medium text-foreground mb-2">Giờ Đóng Cửa</label>
                  <Input
                    type="time"
